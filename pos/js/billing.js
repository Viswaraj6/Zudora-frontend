...
function showDesktopPayment(mode){

    const box = document.getElementById("desktopPaymentDropdown");
    ...
    box.innerHTML = `
        ...
        <input
            ...
            id="desktopReceived"
            value="${amount}"
            oninput="calculateDesktopPayment()">

        <div
            id="desktopQuickButtons"
            class="quick-btns">
        </div>
    ...
    generateDesktopQuickButtons(amount);

    calculateDesktopPayment();
}
